...
@Component({
  selector: 'app-acceuil-audiovisuel',
  templateUrl: './acceuil-audiovisuel.page.html',
  styleUrls: ['./acceuil-audiovisuel.page.scss'],
})
export class AcceuilAudiovisuelPage implements OnInit {
  images = [];
  items: any[] ;
  firebaseData = {
    titre: '',
  ...
  constructor(
    ...
    this.firestore.collection('Electronique').valueChanges().subscribe((res) => {
      this.items = res;
      console.log(res);
