...
@Component({
  selector: 'app-accceuil-btp',
  templateUrl: './accceuil-btp.page.html',
  styleUrls: ['./accceuil-btp.page.scss'],
})
export class AccceuilBtpPage implements OnInit {
  images = [];
  items: any[] ;
  firebaseData = {
    titre: '',
  ...
  constructor(
    ...
    this.firestore.collection('BTP').valueChanges().subscribe((res) => {
      this.items = res;
      console.log(res);
